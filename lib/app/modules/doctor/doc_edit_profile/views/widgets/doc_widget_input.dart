...
class DocWidgetInput extends StatefulWidget {
  DocWidgetInput({
    super.key,
    this.label,
    this.controlC,
  ...
  @override
  State<DocWidgetInput> createState() => _DocWidgetInputState();
}

class _DocWidgetInputState extends State<DocWidgetInput> {
  @override
